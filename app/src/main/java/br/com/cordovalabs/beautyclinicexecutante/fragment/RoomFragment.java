...
import br.com.cordovalabs.beautyclinicexecutante.task.RequesterRooms;
...
public class RoomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.rv_room);
        ...
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                RequesterRooms.request(view.getContext(), recyclerView, refreshLayout);
            }
        });

        RequesterRooms.request(view.getContext(), recyclerView, null);
